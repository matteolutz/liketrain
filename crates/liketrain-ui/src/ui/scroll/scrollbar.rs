...
const SCROLLBAR_THUMB: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.64,
    a: 0.9,
};
const SCROLLBAR_THUMB_HOVER: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.64,
    a: 1.0,
};
const SCROLLBAR: Hsla = Hsla {
    h: 0.,
    s: 0.,
    l: 0.98,
    a: 0.0,
...
impl Scrollbar {
    ...
    fn style_for_active(_cx: &App) -> (Hsla, Hsla, Hsla, Pixels, Pixels, Pixels) {
        (
    ...
    fn style_for_hovered_thumb(_cx: &App) -> (Hsla, Hsla, Hsla, Pixels, Pixels, Pixels) {
        (
            SCROLLBAR_THUMB_HOVER,
            SCROLLBAR,
            BORDER,
    ...
    fn style_for_hovered_bar(_cx: &App) -> (Hsla, Hsla, Hsla, Pixels, Pixels, Pixels) {
        (
            SCROLLBAR_THUMB,
            SCROLLBAR,
    ...
    fn style_for_normal(&self, _cx: &App) -> (Hsla, Hsla, Hsla, Pixels, Pixels, Pixels) {
        let scrollbar_show = self.scrollbar_show.unwrap_or_default();
                ...
                if state.get().dragged_axis == Some(axis) {
                    ...
                    if let Some(last_time) = state.get().last_scroll_time {
                        ...
                        if is_hovered_on_bar {
                            ...
                            idle_state.0 = SCROLLBAR_THUMB.opacity(opacity);
