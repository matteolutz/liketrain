...
RS485::RS485(HardwareSerial *hw_serial, uint8_t re_de_pin)
    : stream(hw_serial), hw_serial(hw_serial), stream_impl(RS485StreamImplementation::HardwareSerial), re_de_pin(re_de_pin)
{
}
